...
_0x3:
	.DB  0x20,0x20,0x20,0x20,0x20,0x63,0x6F,0x75
	.DB  0x72,0x73,0x65,0x0,0x6D,0x69,0x63,0x72
	.DB  0x6F,0x63,0x6F,0x6E,0x74,0x72,0x6F,0x6C
	.DB  0x6C,0x65,0x72,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; .FSTART _main
; 0000 000C     int i,j;
; 0000 000D     char buffer1[] = "microcontroller";
; 0000 000E     char buffer2[] = "     course";
...
_0x4:
; 0000 0014     {
; 0000 0015         for(i=0; i < 15; i++)
	__GETWRN 16,17,0
_0x8:
	__CPWRN 16,17,15
	BRGE _0x9
; 0000 0016         {
; 0000 0017             lcd_gotoxy(i,0);
	ST   -Y,R16
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 0018             lcd_putchar(buffer1[i]);
	MOVW R26,R28
	ADIW R26,12
	ADD  R26,R16
	ADC  R27,R17
	CALL SUBOPT_0x0
; 0000 0019             delay_ms(50);
; 0000 001A         }
	__ADDWRN 16,17,1
	RJMP _0x8
_0x9:
; 0000 001B         for(j=5; j < 11; j++)
	__GETWRN 18,19,5
_0xB:
	__CPWRN 18,19,11
	BRGE _0xC
; 0000 001C         {
; 0000 001D             lcd_gotoxy(j,1);
	ST   -Y,R18
	LDI  R26,LOW(1)
	CALL _lcd_gotoxy
; 0000 001E             lcd_putchar(buffer2[j]);
	MOVW R26,R28
	ADD  R26,R18
	ADC  R27,R19
	CALL SUBOPT_0x0
