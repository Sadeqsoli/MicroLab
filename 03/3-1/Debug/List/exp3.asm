...
_0x0:
	.DB  0x6D,0x69,0x63,0x72,0x6F,0x63,0x6F,0x6E
	.DB  0x74,0x72,0x6F,0x6C,0x6C,0x65,0x72,0x0
	.DB  0x63,0x6F,0x75,0x72,0x73,0x65,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 0010     lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 0011     lcd_putsf("microcontroller");
	__POINTW2FN _0x0,0
	CALL _lcd_putsf
; 0000 0012     lcd_gotoxy(5,1);
	LDI  R30,LOW(5)
	ST   -Y,R30
	LDI  R26,LOW(1)
	CALL _lcd_gotoxy
; 0000 0013     lcd_putsf("course");
	__POINTW2FN _0x0,16
	CALL _lcd_putsf
; 0000 0014 
; 0000 0015 
